...
function Search({ toggleMenu, isMenuOpen }: SearchProps) {
        ...
        <div className="mini-Header">
            <div className="search-div">
                <div className="search-up">
                    <label htmlFor="search" className="Search-label">
                        <div className="search-input">
                            <button className="img-search" onClick={handleSearch} disabled={isLoading}>
                                <img src="/images/svg_elements/Elements/loupeGrey.svg" alt="Search" />
                            </button>
                            <input 
                                type="text" 
                                id="search" 
                    ...
                    <button className={`burger_menu ${isInputFocused ? 'active' : ''}`} onClick={toggleMenu}>
                        <div className="img-Filter">
                            <img
                                src="/images/svg_elements/Elements/Filter.svg"
